  ...
  return (
    <section id="works" className="pt-8 pb-20 px-4 sm:px-6 lg:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Featured Case Study 3: Rani Heritage Gallery (Original Showcase) */}
        {(filter === 'all') && (
          <div className="bg-white rounded-[2.5rem] border border-orange-500/20 p-6 sm:p-9 lg:p-12 shadow-md hover:shadow-xl transition-all mb-10 group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-80 h-80 bg-orange-50/50 rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
              ...
              <div className="lg:col-span-6 flex flex-col">
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-3 py-1 rounded-full bg-orange-100/80 text-orange-950 border border-orange-300/60 text-xs font-semibold flex items-center gap-1.5">
                    <span className="w-2 h-2 rounded-full bg-orange-600 animate-pulse" />
                    Heritage Showcase Live
                  </span>
                  <span className="px-3 py-1 rounded-full bg-zinc-100 text-zinc-700 text-xs font-medium">
                    Since 1973
                  </span>
                  <span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200/50 text-xs font-medium">
                    Sacred Idols &amp; Handicrafts
                  </span>
                </div>
                ...
                <p className="text-sm sm:text-base text-zinc-600 leading-relaxed font-normal mb-8">
                  Curators of fine Indian antiques, consecrated brass idols, and handcrafted teak furniture. An editorial presentation featuring illuminated museum-grade photography, golden accents, and high-performance Netlify Edge delivery.
                </p>
                ...
                <div className="grid grid-cols-3 gap-4 pt-6 border-t border-zinc-100 mb-8">
                  ...
                  <div>
                    <div className="text-2xl sm:text-3xl font-serif text-orange-900 font-medium">
                      Bespoke
                    </div>
                    <div className="text-xs text-zinc-500 mt-1">
                      Editorial Lighting
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <a
                    ...
                    className="flex items-center gap-2 px-7 py-3.5 rounded-full bg-zinc-950 hover:bg-zinc-800 text-white text-xs font-semibold tracking-tight transition shadow-md hover:shadow-lg group/btn cursor-pointer"
                  >
                    <span>Visit Original Gallery</span>
                    <ExternalLink className="w-3.5 h-3.5 transition-transform group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5" />
                  </a>

                  <button
                    onClick={() => onShowToast("Rani Heritage Gallery features fine Indian antiques, brass idols, and teak craftsmanship since 1973")}
                    className="text-xs font-medium text-zinc-600 hover:text-zinc-950 transition flex items-center gap-1.5 cursor-pointer"
                  >
              ...
              <div className="lg:col-span-6 flex flex-col gap-3">
                ...
                >
                  ...
                  <div className="bg-[#24262c] border-b border-zinc-700/50 px-4 py-2.5 flex items-center justify-between text-xs text-zinc-400">
                    ...
                    <div className="bg-[#1c1e22] px-4 py-1 rounded-md border border-zinc-700/60 text-[11px] font-mono text-zinc-300 flex items-center gap-1.5 shadow-xs max-w-xs truncate">
                      ...
                      <span>rani-heritage-gallery-original.netlify.app</span>
                    </div>
                  ...
                  <div className="aspect-[16/10] overflow-hidden bg-black relative">
                    ...
                    <div className="absolute inset-0 bg-black/0 group-hover/preview:bg-black/15 transition-colors flex items-center justify-center">
                      <div className="opacity-0 group-hover/preview:opacity-100 transition-opacity px-4 py-2 rounded-full bg-[#1c1e22]/95 text-white text-xs font-medium backdrop-blur-sm flex items-center gap-2 shadow-lg">
                        <span>Open Original Showcase</span>
                        <ExternalLink className="w-3.5 h-3.5" />
                      </div>
                    </div>
                  </div>
                ...
                {/* Collections chip footer */}
                <div className="flex flex-wrap items-center gap-2 pt-1 text-[11px] font-mono text-zinc-600">
                  <span className="text-zinc-400 text-[10px] uppercase tracking-wider">Showcase:</span>
                  <span className="px-2.5 py-1 rounded-lg bg-white border border-zinc-200 shadow-2xs font-medium">Golden Ganesha</span>
                  <span className="px-2.5 py-1 rounded-lg bg-white border border-zinc-200 shadow-2xs font-medium">Handicrafts</span>
                  <span className="px-2.5 py-1 rounded-lg bg-white border border-zinc-200 shadow-2xs font-medium">Sacred Diya</span>
                  <span className="px-2.5 py-1 rounded-lg bg-white border border-zinc-200 shadow-2xs font-medium">Teak Wood</span>
                </div>
              </div>
